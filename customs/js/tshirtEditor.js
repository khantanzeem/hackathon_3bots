	  ...
	  $("#font-family").change(function() {
	   ...
	   $('#flip_cap').click(
		function() {			   
				if ($(this).attr("data-original-title") == "Show Back View") {
				 ...
				 $("#tshirtFacing").attr("src","img/cap_front.png");			        
				 ...
				 $("#tshirtFacing").attr("src","img/cap_back.png");			    	
	   ...
	   $('#flip_bag').click(
		function() {			   
				if ($(this).attr("data-original-title") == "Show Back View") {
					$(this).attr('data-original-title', 'Show Front View');			        		       
				 $("#tshirtFacing").attr("src","img/bag.png");			        
				 a = JSON.stringify(canvas);
				 canvas.clear();
				 try
				 {
				 ...
				 $(this).attr('data-original-title', 'Show Back View');			    				    	
				 $("#tshirtFacing").attr("src","img/bag_back.png");			    	
				 b = JSON.stringify(canvas);
				 canvas.clear();
				 try
				 {
	   ...
	   $('#flip_shoes').click(
		function() {			   
				if ($(this).attr("data-original-title") == "Show Back View") {
					$(this).attr('data-original-title', 'Show Front View');			        		       
				 $("#tshirtFacing").attr("src","img/shoe_back.png");			        
				 a = JSON.stringify(canvas);
				 canvas.clear();
				 try
				 {
				 ...
				 $(this).attr('data-original-title', 'Show Back View');			    				    	
				 $("#tshirtFacing").attr("src","img/shoe_front.png");			    	
				 b = JSON.stringify(canvas);
				 canvas.clear();
				 try
				 {
